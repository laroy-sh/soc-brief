...
Breaks 30 days of workspace ingestion down per solution and separates auxiliary tables, the query to run before any Sentinel cost conversation. ([per-solution-breakdown — David Alonso](https://github.com/davidalonsod/Dalonso-Security-Repo/blob/main/Sentinel%20Cost%20Optimization/hunting-queries/per-solution-breakdown.kql))
...
Charts which MFA methods your tenant actually uses, which is how you find out how much of the estate is still on SMS before you start enforcing. ([Overview of all MFA methods in use — Nathan Hutchinson](https://github.com/NateHutch365/KQL/blob/main/Log%20Analytics%20and%20Sentinel/Overview%20of%20all%20MFA%20methods%20in%20use.md))
