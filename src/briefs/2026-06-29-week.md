...
Lists accounts Defender for Identity classifies as service accounts but that are neither service principals nor managed service accounts, the ones running on a password somebody set years ago. ([MDI Service Accounts without Service Principals and MSAs — Jay Kerai](https://github.com/jkerai1/KQL-Queries/blob/main/Defender/MDI%20Service%20Accounts%20without%20Service%20Principals%20and%20MSAs.kql))
...
Correlates Dynamics 365 role and team modifications with off-network access inside a short window, aimed at privilege escalation in the business application layer. ([Microsoft Dynamics 365 Privilege Escalation via Role or Team Modification — Benjamin Zulliger](https://github.com/benscha/KQLAdvancedHunting/blob/main/ThreatHunting/Microsoft%20Dynamics%20365%20Privilege%20Escalation%20via%20Role%20or%20Team%20Modification.md))
