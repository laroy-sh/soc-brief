...
Matches browser extension files written to disk against a public list of malicious extension IDs, covering an install path that rarely gets monitored. ([Malicious Browser Extension Downloads using DeviceFileEvents — Jay Kerai](https://github.com/jkerai1/KQL-Queries/blob/main/Defender/Malicious%20Browser%20Extension%20Downloads%20using%20DeviceFileEvents.kql))
...
Watches Image File Execution Options and SilentProcessExit registry keys, a debugger-hijack persistence technique that also doubles as a way to kill security tooling. ([Image File Execution Options (IFEO) or SilentProcessExit Registry Modification — Benjamin Zulliger](https://github.com/benscha/KQLAdvancedHunting/blob/main/Exploit%20Detection/Image%20File%20Execution%20Options%20(IFEO)%20or%20SilentProcessExit%20Registry%20Modification.md))
