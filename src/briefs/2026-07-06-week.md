...
Builds a list of admin accounts, learns the ASNs they normally sign in from, and flags admin sign-ins arriving from a new network. ([adminsignsinfronnewnetwork — Ali Hussein](https://github.com/0xAnalyst/DefenderATPQueries/blob/main/Privilege%20Escalation/adminsignsinfronnewnetwork.md))
...
Finds identities holding Entra admin roles that are synchronised from on-premises Active Directory, the hybrid dependency Microsoft has been advising teams to break. ([Potential Entra Admin Synced back On-premise — Jay Kerai](https://github.com/jkerai1/KQL-Queries/blob/main/Defender/Potential%20Entra%20Admin%20Synced%20back%20On-premise.kql))
