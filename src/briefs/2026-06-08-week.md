...
Enriches Microsoft Graph activity from first-party apps with a sensitive-permission classification pulled in at query time. ([GraphActivityFromFirstPartyApps — Thomas Naunheim](https://github.com/Cloud-Architekt/AzureSentinel/blob/main/Hunting%20Queries/EID-WorkloadIdentities/GraphActivityFromFirstPartyApps.kusto))
...
Lists VM and deployment write operations across 90 days of AzureActivity, the starting point for rogue or unbudgeted VM hunting. ([VM Creation using Azure Activity — Jay Kerai](https://github.com/jkerai1/KQL-Queries/blob/main/Azure/VM%20Creation%20using%20Azure%20Activity.kql))
