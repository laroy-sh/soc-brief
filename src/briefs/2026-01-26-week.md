...
Baselines the countries each user normally signs in from over 90 days, then surfaces authenticator enrollments that happen outside that baseline. ([authenticator_device_enrollment_country_risk_baseline — Daniel Card](https://github.com/mr-r3b00t/KQL/blob/main/operations/authenticator_device_enrollment_country_risk_baseline.kql))
