...
date: 2026-03-23
topics: ["Defender XDR", "MDI", "Entra ID", "Sentinel", "Security Copilot", "SOAR", "M365"]
...
Compares each account's authentication over a 14-day period against a watchlist of domain controllers to surface first-time or unusual authentication paths. ([SecurityEvent-Unusual user account authentication — Jose Sebastián Canós](https://github.com/ep3p/Sentinel_KQL/blob/main/Queries/AD/SecurityEvent-Unusual%20user%20account%20authentication.kql))
...
Audits 30 days of Exchange inbox and transport rule changes with forwarding, redirect and hiding indicators pre-calculated, the standard opening move on a suspected BEC. ([HUNT-02_M365-Exchange-InboxTransportRule-Audit-30d — David Alonso](https://github.com/davidalonsod/Dalonso-Security-Repo/blob/main/Use%20Cases%20Threat%20Hunting/M365OfficeActivity/HuntingQueries/HUNT-02_M365-Exchange-InboxTransportRule-Audit-30d.kql))
