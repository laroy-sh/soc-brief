...
Watches DeviceFileEvents for writes into the macOS SecurityAgentPlugins and LoginHook paths, a persistence spot that survives reboots and rarely changes on a managed Mac fleet. ([macOS LoginWindow Hooks & Authorization Plugins — Benjamin Zulliger](https://github.com/benscha/KQLAdvancedHunting/blob/main/Exploit%20Detection/macOS%20LoginWindow%20Hooks%20&%20Authorization%20Plugins.md))
...
Flags an operator wiping or retiring more than five Intune devices in an hour, the shape a compromised endpoint admin account leaves behind. ([Mass Wipe or Retire Device Action — Thomas Kurth](https://github.com/ThomasKur/Sentinel-And-DefenderXDR/blob/main/Detections/Microsoft-Intune/Mass%20Wipe%20or%20Retire%20Device%20Action.md))
