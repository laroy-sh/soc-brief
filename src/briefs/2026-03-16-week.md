...
Inventories 90 days of successful GPU and high-compute VM deployments from AzureActivity, the baseline you need before cryptojacking detections mean anything. ([HUNT-01_GPU-VM-Deployment-History — David Alonso](https://github.com/davidalonsod/Dalonso-Security-Repo/blob/main/Use%20Cases%20Threat%20Hunting/AzureCustomDetections/HuntingQueries/HUNT-01_GPU-VM-Deployment-History.kql))
...
Tracks changes to the outbound spam policy AutoForwardingMode setting, the tenant-level switch that decides whether external auto-forwarding is possible at all. ([MDO-AutoForwardingMode — Alex Verboon](https://github.com/alexverboon/Hunting-Queries-Detection-Rules/blob/main/Defender%20For%20Office%20365/MDO-AutoForwardingMode.md))
