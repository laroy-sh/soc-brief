...
Reconstructs the IP history of a single device from network telemetry, the lookup you want when an alert gives you an address and a timestamp but no hostname. ([DeviceIPHistory — C.J. May](https://github.com/lawndoc/AdvancedHuntingQueries/blob/main/Utilities/DeviceIPHistory.kusto))
...
Lists recently onboarded devices that never ran the initial full antivirus scan Microsoft recommends after MDE onboarding. ([Windows - Recent Devices Missing Full Scan — Nathan Hutchinson](https://github.com/NateHutch365/KQL/blob/main/Defender%20XDR/Windows%20-%20Recent%20Devices%20Missing%20Full%20Scan.md))
