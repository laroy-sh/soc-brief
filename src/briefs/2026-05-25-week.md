...
Joins anomalous Insider Risk behaviours to the concrete file events behind them for the same user and window, turning a behaviour score into evidence. ([XDR-4_Behavior_To_Event_DrillThrough — David Alonso](https://github.com/davidalonsod/Dalonso-Security-Repo/blob/main/Use%20Cases%20Threat%20Hunting/Purview/XDR/XDR-4_Behavior_To_Event_DrillThrough.kql))
...
Parses triggered PIM alerts out of AuditLogs and assigns severity, covering standing role assignments made outside PIM. ([PIMAlerts — Bert-Jan Pals](https://github.com/Bert-JanP/Hunting-Queries-Detection-Rules/blob/main/Azure%20Active%20Directory/PIMAlerts.md))
