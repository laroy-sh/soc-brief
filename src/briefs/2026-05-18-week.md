...
Estimates what each table would cost in the data lake tier versus analytics, with the per-GB prices exposed as variables you set to your own contract. ([estimate-potential-savings-by-moving-tables-to-data-lake — Michalis Michalos](https://github.com/cyb3rmik3/KQL-threat-hunting-queries/blob/main/Sentinel/estimate-potential-savings-by-moving-tables-to-data-lake.md))
...
Expands Security Copilot activity into the individual resources each session touched, which is the audit trail question that comes up as soon as Copilot is rolled out. ([Copilot-DefenderThreatProtection — Alex Verboon](https://github.com/alexverboon/Hunting-Queries-Detection-Rules/blob/main/Copilot/Copilot-DefenderThreatProtection.md))
