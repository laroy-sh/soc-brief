...
Catches the Azure RBAC elevate-access toggle, the one-click path from Global Administrator to User Access Administrator over every subscription in the tenant. ([Azure RBAC Elevation via User Access Admin toggle — Nathan Hutchinson](https://github.com/NateHutch365/KQL/blob/main/Log%20Analytics%20and%20Sentinel/Azure%20RBAC%20Elevation%20via%20User%20Access%20Admin%20toggle.md))
...
Joins IdentityInfo against the exposure graph to list accounts flagged with leaked credentials, sorted so critical identities surface first. ([HuntAccountsWithLeakedCredentials — Robbe Van den Daele](https://github.com/HybridBrothers/Hunting-Queries-Detection-Rules/blob/main/Exposure%20Management/HuntAccountsWithLeakedCredentials.md))
