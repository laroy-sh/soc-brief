...
Correlates non-compliant or health-flagged Intune devices with LDAP reconnaissance from the same host, pairing device posture with directory enumeration. ([Suspicious LDAP Reconnaissance from Non-Compliant Devices — Benjamin Zulliger](https://github.com/benscha/KQLAdvancedHunting/blob/main/ThreatHunting/Suspicious%20LDAP%20Reconnaissance%20from%20Non-Compliant%20Devices.md))
