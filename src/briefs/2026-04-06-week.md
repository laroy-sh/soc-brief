...
Correlates history-rewriting git commands with suspicious node.exe activity on the same device, aimed at developer workstation supply chain tampering. ([Correlation_Git_And_VSCode_Task_Abuse — Ali Hussein](https://github.com/0xAnalyst/DefenderATPQueries/blob/main/Git%20Abuse%20Detection/Correlation_Git_And_VSCode_Task_Abuse.md))
